      ...
      <main className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
        <div className="mb-6 rounded-2xl bg-gradient-to-r from-indigo-950 via-slate-900 to-indigo-900 p-6 text-white shadow-xl shadow-indigo-950/10">
          ...
          <p className="mt-1 text-sm text-indigo-200/80">
            Join your teacher&apos;s live practice room, answer Part 1–3 questions and get
            instant AI feedback on your fluency, grammar, vocabulary and pronunciation.
          </p>
          <div className="mt-4">
            <Link href="/student/report">
              <Button className="bg-white/10 text-white border border-white/15 backdrop-blur-md hover:bg-white/20">
                My Speaking Report →
              </Button>
            </Link>
          </div>
        ...
        <div className="mt-6 grid gap-6">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <CardTitle>Recent Sessions ({attempts.length})</CardTitle>
              <Link href="/student/report">
